...
[[ $(create_device nvme | jq -r '.id') == 'nvme:plugin1-device1' ]]
[[ $(create_device nvmf_tcp | jq -r '.id') == 'nvmf_tcp:plugin1-device2' ]]
...
[[ $(create_device nvme | jq -r '.id') == 'nvme:plugin2-device1' ]]
[[ $(create_device nvmf_tcp | jq -r '.id') == 'nvmf_tcp:plugin2-device2' ]]
